# This Makefile is for the Calendar::Simple extension to perl.
#
...
#	ABSTRACT_FROM => q[Simple.pm]
#	AUTHOR => q[A. U. Thor <a.u.thor@a.galaxy.far.far.away>]
#	NAME => q[Calendar::Simple]
#	PREREQ_PM => {  }
#	VERSION_FROM => q[Simple.pm]
...
DISTNAME = Calendar-Simple
NAME_SYM = Calendar_Simple
VERSION = 0.01
VERSION_SYM = 0_01
XS_VERSION = 0.01
INST_BIN = blib/bin
...
FULLEXT = Calendar/Simple
BASEEXT = Simple
PARENT_NAME = Calendar
DLBASE = $(BASEEXT)
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/Calendar
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Calendar
...
TO_INST_PM = Simple.pm

PM_TO_BLIB = Simple.pm \
...
manifypods : pure_all Simple.pm
	@$(POD2MAN) \
	Simple.pm \
	$(INST_MAN3DIR)/Calendar::Simple.$(MAN3EXT)
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Calendar-Simple\" VERSION=\"0,01,0,0\">\n}. qq{\t<TITLE>Calendar-Simple</TITLE>\n}. qq{\t<ABSTRACT>Perl extension to create simple calendars</ABSTRACT>\n}. qq{\t<AUTHOR>A. U. Thor &lt;a.u.thor\@a.galaxy.far.far.away&gt;</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Calendar-Simple.ppd
